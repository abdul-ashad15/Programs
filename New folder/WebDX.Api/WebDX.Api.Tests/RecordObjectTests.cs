...
namespace WebDX.Api.Tests
{
	...
	public class RecordObjectTests
	{
		...
		public void Init()
		{
			...
			m_Record = WDERecord.Create((IWDERecords) m_Records);
		}
		...
		public void CreateMissingFields()
		{
			...
			irec.CreateFields((IWDERecordDef) m_RecordDef);
		...
		public void CreateFields()
		{
			...
			IWDERecordDef def = (IWDERecordDef) m_RecordDef;
