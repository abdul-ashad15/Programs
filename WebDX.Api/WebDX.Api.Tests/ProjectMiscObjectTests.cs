...
namespace WebDX.Api.Tests
{
	...
	public class ProjectMiscObjectTests
	{
		...
		public void SessionDefsWTX()
		{
			...
			//defs[0].AllowedRejectCodes.Add(m_Project.RejectCodes[0]);
		...
		public void SessionDefsRFX()
		{
			...
			//obj = (WDEBaseCollectionItem) m_Project.RejectCodes[0];
			//iproj.Resolver.AddObject(obj.GetNamePath(), m_Project.RejectCodes[0]);
			...
			//Assert.AreEqual(1, defs[0].AllowedRejectCodes.Count, "AllowedRejectCodes.Count");
			//Assert.AreSame(m_Project.RejectCodes[0], defs[0].AllowedRejectCodes[0], "AllowedRejectCodes[0] and RejectCodes[0] are not the same. Expected same.");

			//Assert.AreEqual(0, defs[1].AllowedRejectCodes.Count, "1 allowedrejectcodes.count");
		...
		//{
		//	IWDERejectCodes codes = WDERejectCodes.Create(m_Project);
		//	codes.Add("01");
		//	codes.Add("02");
		//	codes[0].Description = "BAD SCAN";
		//	codes[1].RequireDescription = true;
		...
		public void RejectCodesRFX()
		{
			...
			//Assert.AreEqual("01", codes[0].Name, "01");
			//Assert.AreEqual("BAD SCAN", codes[0].Description, "Description");
			//Assert.IsFalse(codes[0].RequireDescription, "RequireDescription[0] is true. Expected false.");
			//Assert.AreEqual("02", codes[1].Name, "02");
			//Assert.AreEqual("", codes[1].Description, "Description[1]");
			//Assert.IsTrue(codes[1].RequireDescription, "RequireDescription[1] is false. Expected true.");
		}
