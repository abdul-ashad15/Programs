...
namespace WebDX.Api.Tests
{
	...
	public class DataObjectsTests
	{
		...
		public void CharRepairReadXml()
		{
			...
			Dictionary<string, WebDEApiVersion> dXmlChangesVersionOnPropiertiesAndCollections = new Dictionary<string, WebDEApiVersion>();
			dXmlChangesVersionOnPropiertiesAndCollections.Add("IWDECharRepair.Confidence", new WebDEApiVersion("1.0.0.0", null));
